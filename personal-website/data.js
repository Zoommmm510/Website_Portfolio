(function () {
  ...
  seedProjects.push(
    {
      id: "proj-9",
      title: "SBDW Rocket Systems Portfolio",
      category: "rocketry",
      categoryLabel: "Rocketry",
      subfield: "SBDW",
      type: "Student Team",
      shortSummary: "A project lane for documenting SBDW rocket subsystem work across structures, propulsion, fluids, avionics, and GNC.",
      description: "SBDW work can capture subsystem-level contributions, design reviews, integration notes, and launch-readiness evidence.",
      details: "This project lane is prepared for SBDW uploads and documentation. Use it to organize subsystem artifacts, design-review evidence, integration notes, build photos, and test results into one recruiter-ready technical story.",
      tags: ["Rocketry", "Systems Engineering", "Integration", "Design Review", "Testing"],
      acronyms: [{ acronym: "GNC", meaning: "Guidance, Navigation, and Control" }],
      coverImage: "https://images.unsplash.com/photo-1517976547714-720226b864c1?auto=format&fit=crop&w=1200&q=80",
      gallery: [
      ...
      fallback: "linear-gradient(135deg, #1d3150, #08101d)",
    },
    {
      id: "proj-10",
      title: "Vehicle Chassis Design Studies",
      category: "uav-aircraft",
      categoryLabel: "EV Formula / Drones / Aircraft",
      subfield: "Chassis",
      type: "Design Analysis",
      shortSummary: "A project lane for chassis packaging, load paths, mounting decisions, and structural design evidence.",
      description: "Chassis work connects frame layout, mounting strategy, stiffness, access, and manufacturability.",
      details: "Use this entry for EV Formula, drone, aircraft, or vehicle chassis evidence. It is structured to show constraints, geometry decisions, analysis notes, and how the chassis supports the surrounding systems.",
      tags: ["Chassis", "Structures", "Load Path", "CAD", "Design Analysis"],
      ...
      fallback: "linear-gradient(135deg, #253b5e, #0c1523)",
    },
    {
      id: "proj-11",
      title: "Aerodynamics Study Portfolio",
      category: "uav-aircraft",
      categoryLabel: "EV Formula / Drones / Aircraft",
      subfield: "Aerodynamics",
      type: "Test Analysis",
      shortSummary: "A project lane for aerodynamic geometry, flow assumptions, drag/lift tradeoffs, and test evidence.",
      description: "Aerodynamics entries can connect vehicle body design with flow behavior, simulation, and measured performance.",
      details: "Use this entry for airfoil, bodywork, drone, aircraft, or EV aero evidence. The page is structured for geometry decisions, CFD or test references, and design changes tied to performance.",
      tags: ["Aerodynamics", "CFD", "Design Analysis", "Testing", "Data Analysis"],
      acronyms: [{ acronym: "CFD", meaning: "Computational Fluid Dynamics" }],
      coverImage: "https://images.unsplash.com/photo-1436491865332-7a61a109cc05?auto=format&fit=crop&w=1200&q=80",
      gallery: [
        "https://images.unsplash.com/photo-1436491865332-7a61a109cc05?auto=format&fit=crop&w=900&q=80",
        "https://images.unsplash.com/photo-1474302770737-173ee21bab63?auto=format&fit=crop&w=900&q=80",
        "https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?auto=format&fit=crop&w=900&q=80",
      ],
      fallback: "linear-gradient(135deg, #213754, #09111f)",
    },
    {
      id: "proj-12",
      title: "Vehicle Design Analysis Workbench",
      category: "uav-aircraft",
      categoryLabel: "EV Formula / Drones / Aircraft",
      subfield: "Design Analysis",
      type: "Design Analysis",
      shortSummary: "A project lane for comparing concepts, constraints, simulations, and decision tradeoffs.",
      description: "Design analysis work turns rough concepts into defensible engineering choices.",
      details: "Use this entry for trade studies, model comparisons, analysis notes, and final recommendations. The goal is to show how design decisions were made and why certain options were selected.",
      tags: ["Design Analysis", "Trade Study", "Simulation", "Requirements", "Technical Writing"],
      coverImage: "https://images.unsplash.com/photo-1581092580497-e0d23cbdf1dc?auto=format&fit=crop&w=1200&q=80",
      gallery: [
        "https://images.unsplash.com/photo-1581092580497-e0d23cbdf1dc?auto=format&fit=crop&w=900&q=80",
        "https://images.unsplash.com/photo-1581093458791-9d42cc030aa8?auto=format&fit=crop&w=900&q=80",
        "https://images.unsplash.com/photo-1516321318423-f06f85e504b3?auto=format&fit=crop&w=900&q=80",
      ],
      fallback: "linear-gradient(135deg, #1f3554, #111827)",
    },
    {
      id: "proj-13",
      title: "Vehicle Test Analysis Evidence Log",
      category: "uav-aircraft",
      categoryLabel: "EV Formula / Drones / Aircraft",
      subfield: "Test Analysis",
      type: "Test Analysis",
      shortSummary: "A project lane for test plans, measurements, result interpretation, and design feedback.",
      description: "Test analysis links measured evidence to engineering decisions and next design iterations.",
      details: "Use this entry for test setup photos, instrumentation notes, result plots, observations, and corrective actions. It is designed to help interviewers see how evidence changed the design.",
      tags: ["Testing", "Test Analysis", "Data Analysis", "Verification", "Technical Writing"],
      coverImage: "https://images.unsplash.com/photo-1518152006812-edab29b069ac?auto=format&fit=crop&w=1200&q=80",
      gallery: [
        "https://images.unsplash.com/photo-1518152006812-edab29b069ac?auto=format&fit=crop&w=900&q=80",
        "https://images.unsplash.com/photo-1532094349884-543bc11b234d?auto=format&fit=crop&w=900&q=80",
        "https://images.unsplash.com/photo-1507413245164-6160d8298b31?auto=format&fit=crop&w=900&q=80",
      ],
      fallback: "linear-gradient(135deg, #23385a, #0c1422)",
    },
    {
      id: "proj-14",
      ...
      subfield: "Paper",
      type: "Research",
      shortSummary: "A project lane for research papers, literature framing, methods, results, and conclusions.",
      description: "Paper entries can organize research motivation, method, evidence, and contribution.",
      details: "Use this entry for draft papers, final papers, abstract development, literature context, figures, and research results. The goal is to show technical thinking and communication quality.",
      tags: ["Research", "Technical Writing", "Data Analysis", "Documentation"],
      acronyms: [{ acronym: "R&D", meaning: "Research and Development" }],
    ...
    {
      id: "proj-15",
      title: "Thesis Research Planning",
      category: "research",
      categoryLabel: "Research",
      subfield: "Thesis",
      type: "Research",
      shortSummary: "A project lane for thesis-style research planning, scope, assumptions, and technical contribution.",
      description: "Thesis work benefits from clear problem framing, methods, constraints, and research value.",
      details: "Use this entry for thesis planning materials, advisor feedback, research questions, methods, datasets, and results as they develop.",
      tags: ["Research", "Technical Writing", "Project Planning", "Data Analysis"],
      ...
      fallback: "linear-gradient(135deg, #1f324f, #101827)",
    },
    {
      id: "proj-16",
      title: "Experimental Dataset Archive",
      category: "research",
      categoryLabel: "Research",
      subfield: "Dataset",
      type: "Research",
      shortSummary: "A project lane for datasets, measurement context, data cleanup, and analysis outputs.",
      description: "Dataset entries help translate raw evidence into interpretable engineering conclusions.",
      details: "Use this entry for dataset notes, measurement conditions, preprocessing steps, plots, and findings. It is especially useful for showing rigor behind research claims.",
      tags: ["Dataset", "Data Analysis", "Python", "Testing", "Documentation"],
      ...
      fallback: "linear-gradient(135deg, #1c3455, #0b1422)",
    },
    {
      id: "proj-17",
      title: "Conference Poster Research Board",
      category: "research",
      categoryLabel: "Research",
      subfield: "Conference Poster",
      type: "Research",
      shortSummary: "A project lane for poster layout, visual evidence, key findings, and presentation notes.",
      description: "Poster work shows technical communication through concise visuals and defensible claims.",
      details: "Use this entry for poster drafts, final poster images, presentation notes, and the research evidence supporting each figure.",
      tags: ["Conference Poster", "Technical Presentation", "Research", "Data Visualization"],
      coverImage: "https://images.unsplash.com/photo-1503428593586-e225b39bddfe?auto=format&fit=crop&w=1200&q=80",
      gallery: [
      ...
      fallback: "linear-gradient(135deg, #26395a, #0d1522)",
    },
    {
      id: "proj-18",
      title: "Technical Report Library",
      category: "research",
      categoryLabel: "Research",
      subfield: "Technical Report",
      type: "Research",
      shortSummary: "A project lane for formal reports, requirements, methods, evidence, and recommendations.",
      description: "Technical reports make engineering judgment visible through structure, evidence, and traceability.",
      details: "Use this entry for lab reports, design reports, technical memos, test reports, or review documents that show how you communicate engineering work.",
      tags: ["Technical Report", "Technical Writing", "Documentation", "Verification"],
      ...
      fallback: "linear-gradient(135deg, #1d3554, #0a1321)",
    },
    {
      id: "proj-19",
      title: "Solar Regatta Boat Competition",
      category: "competitions",
      categoryLabel: "Competitions",
      subfield: "Solar Regatta Boat Competition",
      type: "Competition",
      shortSummary: "A project lane for solar boat systems, marine packaging, propulsion, power, and race-readiness evidence.",
      description: "Solar Regatta work connects marine engineering, electrical power, mechanical packaging, and team execution.",
      details: "Use this entry for hull or structure photos, solar/electrical layout, propulsion decisions, build tasks, test notes, and competition-day evidence.",
      tags: ["Solar Regatta", "Naval / Marine Engineering", "Systems Engineering", "Fabrication", "Testing"],
      ...
      fallback: "linear-gradient(135deg, #184260, #07131e)",
    },
    {
      id: "proj-20",
      title: "Engineering Design Challenge Portfolio",
      category: "competitions",
      categoryLabel: "Competitions",
      subfield: "Design Challenges",
      type: "Competition",
      shortSummary: "A project lane for short-cycle design challenges, constraint tradeoffs, prototypes, and presentation outcomes.",
      description: "Design challenges show fast engineering judgment under time, resource, and communication constraints.",
      details: "Use this entry for challenge prompts, concept sketches, prototypes, testing, tradeoffs, and final presentation materials.",
      tags: ["Competition", "Rapid Prototyping", "Trade Study", "Technical Presentation", "Teamwork"],
      ...
      fallback: "linear-gradient(135deg, #213756, #0d1420)",
    },
    {
      id: "proj-21",
      title: "Structural Component CAD Library",
      category: "cad-projects",
      categoryLabel: "CAD Projects",
      subfield: "Structural Components",
      type: "CAD / Fabrication",
      shortSummary: "A project lane for brackets, supports, structural members, load-path thinking, and manufacturing-ready drawings.",
      description: "Structural component CAD shows how geometry, loads, manufacturability, and documentation come together.",
      details: "Use this entry for CAD models, drawings, load assumptions, material decisions, fabrication notes, and inspection-ready views.",
      tags: ["CAD", "Structures", "Load Path", "GD&T", "Design for Manufacturing"],
      acronyms: [{ acronym: "GD&T", meaning: "Geometric Dimensioning and Tolerancing" }],
      ...
      fallback: "linear-gradient(135deg, #23395c, #0c1422)",
    },
    {
      id: "proj-22",
      title: "Rapid Concept CAD Studies",
      category: "cad-projects",
      categoryLabel: "CAD Projects",
      subfield: "Rapid Concepts",
      type: "CAD / Fabrication",
      shortSummary: "A project lane for fast CAD ideation, geometry options, quick prototypes, and design iteration.",
      description: "Rapid concept work shows how early ideas become useful engineering directions.",
      details: "Use this entry for concept sketches, CAD variants, prototype photos, rejected alternatives, and final design reasoning.",
      tags: ["CAD", "Rapid Prototyping", "Design Iteration", "Mechanical Design"],
      coverImage: "https://images.unsplash.com/photo-1581093458791-9d42cc030aa8?auto=format&fit=crop&w=1200&q=80",
      gallery: [
        "https://images.unsplash.com/photo-1581093458791-9d42cc030aa8?auto=format&fit=crop&w=900&q=80",
        "https://images.unsplash.com/photo-1581092580497-e0d23cbdf1dc?auto=format&fit=crop&w=900&q=80",
        "https://images.unsplash.com/photo-1537462715879-360eeb61a0ad?auto=format&fit=crop&w=900&q=80",
      ],
      fallback: "linear-gradient(135deg, #243a5c, #0d1524)",
    },
    {
      id: "proj-23",
      title: "Mechanical / Fabrication Builds",
      category: "hands-on-home-projects",
      categoryLabel: "Hands-On Home Projects",
      subfield: "Mechanical / Fabrication",
      type: "Hands-On Technical Work",
      shortSummary: "A project lane for physical builds, shop work, fixtures, material choices, and assembly evidence.",
      description: "Mechanical fabrication projects show practical judgment: measure, cut, fit, assemble, inspect, and revise.",
      details: "Use this entry for home builds, shop builds, fixtures, frames, repair work, or practical mechanical projects with before/after evidence.",
      tags: ["Fabrication", "Mechanical Design", "Assembly", "Tooling", "Process Planning"],
      ...
      fallback: "linear-gradient(135deg, #26395a, #0d1421)",
    },
    {
      id: "proj-24",
      title: "Interior Design / Fabrication Builds",
      category: "hands-on-home-projects",
      categoryLabel: "Hands-On Home Projects",
      subfield: "Interior Design / Fabrication",
      type: "Hands-On Technical Work",
      shortSummary: "A project lane for interior layouts, finish work, human factors, fabrication, and installation decisions.",
      description: "Interior fabrication can show engineering thinking through layout, tolerances, access, usability, and finish quality.",
      details: "Use this entry for interior build photos, layout planning, material selection, assembly steps, constraints, and final installation evidence.",
      tags: ["Interior Fabrication", "Human Factors", "Fabrication", "Design for Manufacturing"],
      ...
      fallback: "linear-gradient(135deg, #203554, #0b1423)",
    },
    {
      id: "proj-25",
      title: "Residential Systems Work",
      category: "hands-on-home-projects",
      categoryLabel: "Hands-On Home Projects",
      subfield: "Residential Systems",
      type: "Hands-On Technical Work",
      shortSummary: "A project lane for home systems, troubleshooting, installation, repair logic, and practical constraints.",
      description: "Residential systems projects can demonstrate diagnosis, safety awareness, process planning, and applied systems thinking.",
      details: "Use this entry for home system work, before/after photos, troubleshooting notes, installation constraints, and the reasoning that led to the final fix.",
      tags: ["Systems Thinking", "Diagnostics", "Repair", "Process Planning", "Testing"],
      coverImage: "https://images.unsplash.com/photo-1581091870622-1e7e97c95088?auto=format&fit=crop&w=1200&q=80",
      gallery: [
        "https://images.unsplash.com/photo-1581091870622-1e7e97c95088?auto=format&fit=crop&w=900&q=80",
        "https://images.unsplash.com/photo-1581092160607-ee22621dd758?auto=format&fit=crop&w=900&q=80",
        "https://images.unsplash.com/photo-1503387762-592deb58ef4e?auto=format&fit=crop&w=900&q=80",
      ],
      fallback: "linear-gradient(135deg, #223756, #0c1421)",
    }
  );
  ...
  function normalizeProject(project) {
    ...
    return {
      ...
      acronyms: Array.isArray(project.acronyms) ? project.acronyms : [],
